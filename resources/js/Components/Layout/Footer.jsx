    ...
    return (
        <footer className="bg-[#0a0a0a] border-t border-white/5 relative overflow-hidden z-40">
            ...
            <div className="container-custom py-10 md:py-16 relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 md:gap-6">
                    ...
                    <div className="md:col-span-3 flex flex-col items-start md:items-end z-20 relative h-[150px] sm:h-[180px] md:h-auto">
                        ...
                        <div className="flex gap-3 md:hidden">
                            {/* Instagram */}
                            <a href="https://instagram.com/ak_kreatif" target="_blank" rel="noopener noreferrer" aria-label="Instagram AK Kreatif" className="w-11 h-11 rounded-full bg-white/8 border border-white/10 flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-red-500 hover:to-fuchsia-500 hover:border-transparent transition-all duration-300 text-white/60 hover:text-white">
                            ...
                            {/* YouTube */}
                            <a href="https://youtube.com/@akkreatif" target="_blank" rel="noopener noreferrer" aria-label="YouTube AK Kreatif" className="w-11 h-11 rounded-full bg-white/8 border border-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:border-transparent transition-all duration-300 text-white/60 hover:text-white">
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                            </a>
                            {/* WhatsApp */}
                            <a href="https://wa.me/6285224302550?text=Halo%20AK%20Kreatif!%20Saya%20ingin%20berkonsultasi%20mengenai%20layanan%20Anda.%20%F0%9F%99%8F" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp AK Kreatif" className="w-11 h-11 rounded-full bg-white/8 border border-white/10 flex items-center justify-center hover:bg-[#10b981] hover:border-transparent transition-all duration-300 text-white/60 hover:text-white">
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.553 4.116 1.524 5.845L.057 23.852l6.174-1.442A11.945 11.945 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.933a9.921 9.921 0 0 1-5.352-1.564l-.383-.228-3.967.927.967-3.864-.251-.396A9.894 9.894 0 0 1 2.067 12C2.067 6.52 6.52 2.067 12 2.067c5.48 0 9.933 4.453 9.933 9.933 0 5.481-4.453 9.933-9.933 9.933z"/></svg>
                            </a>
                        </div>
                            ...
                            <IpadPro className="group hover:-translate-y-4 hover:shadow-[0_40px_100px_rgba(16,185,129,0.2)] transition-all duration-700">
                                ...
                                <div className="w-full h-full bg-[#0a0a0a] relative overflow-hidden flex flex-col items-center justify-center">
                                    ...
                                    <div className="relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-4 flex gap-6 shadow-2xl">
                                        {/* Instagram */}
                                        <a href="https://instagram.com/ak_kreatif" target="_blank" rel="noopener noreferrer" className="w-16 h-16 rounded-[1rem] bg-black/40 border border-white/10 flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-red-500 hover:to-fuchsia-500 hover:border-transparent transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(236,72,153,0.4)] group/icon relative">
                                        ...
                                        {/* YouTube */}
                                        <a href="https://youtube.com/@akkreatif" target="_blank" rel="noopener noreferrer" className="w-16 h-16 rounded-[1rem] bg-black/40 border border-white/10 flex items-center justify-center hover:bg-[#FF0000] hover:border-transparent transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(255,0,0,0.4)] group/icon relative">
                                            <svg className="w-8 h-8 text-white/70 group-hover/icon:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        {/* WhatsApp */}
                                        <a href="https://wa.me/6285224302550?text=Halo%20AK%20Kreatif!%20Saya%20ingin%20berkonsultasi%20mengenai%20layanan%20Anda.%20%F0%9F%99%8F" target="_blank" rel="noopener noreferrer" className="w-16 h-16 rounded-[1rem] bg-black/40 border border-white/10 flex items-center justify-center hover:bg-[#10b981] hover:border-white/30 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(16,185,129,0.2)] group/icon relative">
                                            <svg className="w-8 h-8 text-white/70 group-hover/icon:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Bottom Bar */}
                <div className="mt-10 md:mt-16 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-center items-center gap-3 md:gap-4 font-mono text-[10px] text-white/30 uppercase tracking-widest relative z-30">
